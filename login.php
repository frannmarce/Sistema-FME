...
if($_SERVER['REQUEST_METHOD']==='POST'){
  ...
  $stmt = $pdo->prepare('SELECT id_usuario, nombre_usuario, contraseña_usuario, id_rol, email_verificado
                         FROM Usuario
    ...
    <section class="card">
      ...
      <form method="post" action="login.php" id="loginForm" novalidate>
        ...
        <div class="actions">
          ...
          <a class="link small" href="recuperar_password.php">¿Olvidaste tu contraseña?</a>
        </div>
