...
('Distribuidora Norte', '3704898795', 'norte@gmail.com', 3),
('Proveeduría Sur', '3704785215', 'sur@gmail.com', 4),
('ElectroFME', '37047458658', 'electro@gmail.com', 5),
('OfiCenter', '3704333215', 'ofi@gmail.com', 6),
('FerreMax', '3704225487', 'ferre@gmail.com', 7),
('AlimFormosa', '3704665721', 'alim@gmail.com', 8);
...
-- Consulta de Productos ordenado con su id y añadiendo la categoria
SELECT p.id_producto, p.nombre_producto, p.stock_producto, c.nombre_categoria AS categoria
FROM Producto p
INNER JOIN Categoria c ON p.id_categoria = c.id_categoria
ORDER BY p.id_producto;

-- Consulta de movimiento de stock con nombre del producto
SELECT m.id_movimiento, m.fecha_movimiento, p.nombre_producto, m.cantidad_movimiento
FROM Movimiento m
INNER JOIN Producto p ON m.id_producto = p.id_producto
ORDER BY m.fecha_movimiento ASC;

-- Consulta de usuarios con su numero de celular
SELECT p.nombre_persona, p.apellido_persona, p.telefono_persona, u.correo_usuario
FROM Usuario u
